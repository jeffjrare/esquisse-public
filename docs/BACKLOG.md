...
| B-024 | 2026-08-18 | 🐛 bug | med? | 1300 | Give spec an explicit continuation after the user answers Je ne sais pas — montre-moi où. | review: three-zone-conclusion-spec-arch |  |  | Open |
...
| B-043 | 2026-08-19 | ✨ improvement | lo | 600 | Expose stale roadmap/epic state beside live ledger facts without adding a second writer. | manual (external review 2026-08-19 — ROADMAP.md showed B-028 Open after the backlog marked it Done) | aug-18-improv |  | Open |
...
| B-075 | 2026-08-21 | ✨ improvement | med | 700 | Represent parked versus executing work honestly in existing readers; choose a minimal convention before adding a status. | manual (roadmap correction 2026-08-21) |  |  | Open |
| B-076 | 2026-08-21 | ✨ improvement | med? | 1000 | Retain a durable inspectable evidence reference per named UI state, using existing plan logging. | manual (roadmap correction 2026-08-21) |  |  | Open |
...
| B-079 | 2026-08-21 | ✨ improvement | hi? | 400 | Offer a scoped advance target from roadmap when discussing one entry. | build: advance-entry-scoping Phase 1 |  |  | Open |
...
| B-107 | 2026-09-02 | 🐛 bug | med? | 1100 | Align land handling of an unrunnable verification command with build acceptance, without weakening the proved criterion. | build: auto-step-that-cannot-run Phase 2 | aug-18-improv |  | Open |
...
| B-129 | 2026-09-06 | 🐛 bug | hi? | 300 | Make roadmap completion rollups respect outstanding item acceptance rather than equating a completed plan with a delivered outcome. | manual (roadmap refresh 2026-09-06, cc185da) |  |  | Open |
...
| B-163 | 2026-09-15 | ✨ improvement | lo? | 1200 | Stop extracting a documentation path as an executable auto-step command while preserving legitimate executable paths. | observed: build-reads-its-context-once Phase 1 |  |  | Open |
...
| B-169 | 2026-09-19 | ✨ improvement | hi | 200 | Autonomy epic: A and standards arbitration B delivered; finish D via B-179, then evidence-led specialist guidance C. | work | esq-decides-implementation-detail |  | Open |
...
| B-172 | 2026-09-20 | ✨ improvement | lo? | 500 | Assign an initial rank when adding a backlog row; keep the sequence complete without a separate rerank. | build: every-open-item-is-ranked Phase 3 |  |  | Open |
...
| B-179 | 2026-09-21 | debt | hi | 100 | Provide a bounded safe correction/disposition for a completed plan when corrective depth is exhausted. | observed: /esq:converge on observation-path-before-manual-fixes-fixes, 2026-09-21 | esq-decides-implementation-detail |  | Open |
